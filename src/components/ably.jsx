...
class AblyList extends Component {

    apiKey = 'm2QWfQ.RrqJkw:oKDq7Hdy3hhpXoyx'
    clientId = 'client-' + Math.random().toString(36).substr(2, 16)
    realtime = new Ably.Realtime({ key: apiKey, clientId: clientId })
    AblyRealtime = realtime.channels.get('ChatChannel')
...
var connections = {}
var currentChat
var apiKey = 'm2QWfQ.RrqJkw:oKDq7Hdy3hhpXoyx'
